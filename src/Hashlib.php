...
class Hashlib implements HashlibInterface
{
    /**
     * The seps divider.
     *
     ...
     * The math class.
     *
     * @var \Hashlib\Math\MathInterface
     */
    protected $math;

    /**
     * Create a new Hashlib instance.
     *
     * @param string $salt
     * @param int $minHashLength
     * @param string $alphabet
     *
     * @throws \Hashlib\HashlibException
     *
     * @return void
     */
    public function __construct($salt = '', $minHashLength = 0, $alphabet = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
    {
        ...
        if (strlen($this->alphabet) < 16) {
            throw new HashlibException('Alphabet must contain at least 16 unique characters.');
        }

        if (strpos($this->alphabet, ' ') !== false) {
            throw new HashlibException('Alphabet can\'t contain spaces.');
        }
     ...
     *
     * @return \Hashlib\Math\Bc|\Hashlib\Math\Gmp
     */
